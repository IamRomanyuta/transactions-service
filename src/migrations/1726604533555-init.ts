...
export class Migration1726604533555 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "transactions" ("id" uuid NULL DEFAULT gen_random_uuid(), "userId" integer NOT NULL, "amount" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a219afd8dd77ed80f5a862f1db9" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `INSERT INTO public.user_balances ("userId", balance) VALUES (1, 100)`,
    );
    await queryRunner.query(
      `INSERT INTO public.user_balances ("userId", balance) VALUES (2, 0)`,
    );
  }
